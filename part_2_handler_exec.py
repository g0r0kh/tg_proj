...
async def fill_join(new_entry):
    try:
        ...
        df_respond.to_csv(os.path.join(os.path.dirname(__file__), 'tg_repo (copy)', 'responde_data.txt'), sep='\t', index=False)
            ...
            logger.error(f"Error in fill_join function: {e}")
...
async def start_over(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        return START_ROUTES
            ...
            logger.error(f"Error in start_over function: {e}")
async def one(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        return START_ROUTES
            ...
            logger.error(f"Error in one function: {e}")
...
async def two(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        return END_ROUTES
            ...
            logger.error(f"Error in two function: {e}")
async def three(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        return ConversationHandler.END
            ...
            logger.error(f"Error in three function: {e}")
def main() -> None:
    try:
    # upload main params
